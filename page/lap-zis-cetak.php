...
$sql_infaq = "SELECT * FROM tr_zis WHERE id_petugas = '".$petugas."' ORDER BY tanggal ASC";
...
// data pengeluaran
$sql_keluar = "SELECT * FROM tr_pengeluaran  WHERE id_petugas = '".$petugas."' AND jenis_pengeluaran = 'ZIS' ORDER BY tanggal ASC";
