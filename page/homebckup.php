                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">Rp. <?php echo number_format($r_perlalu_op['SaldoLalu'],2,',','.');?></td>
                                        <td class="text-right">Rp. <?php echo number_format($r_perlalu_pem['SaldoLalu'],2,',','.');?></td>
                                        <td class="text-right">Rp. <?php echo number_format($r_perlalu_zis['SaldoLalu'],2,',','.');?></td>
                                    </tr>
                                    <tr>
                                        <td>Penerimaan</td>
