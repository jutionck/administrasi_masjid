        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-pink hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">SALDO KAS OPERASIONAL</div>
            ...
            <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">SALDO KAS PEMBANGUNAN</div>
            ...
            <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-light-green hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">SALDO KAS ZIS</div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th class="text-center">Periode <?php echo @$tgl_awal['tgl_awal'];?></th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">Rp. <?php echo number_format($saldoperiode3,2,',','.');?></td>
                                    </tr>
                                    <tr>
                                        <td>Penerimaan</td>
                    ...
                    <div class="panel-footer">
                                <form class="form-inline" action="rekapkas_update.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="rekap" class="btn btn-success">Simpan Rekap</button>
                                    </div>
                                    <!-- <div class="form-group">
                                        <?php
                                            if($i == 1) {
...
{
    global $kdb;
    $sql = "SELECT a.`id_petugas`,b.`id_masjid`, SUM(`nominal`) as ZIS FROM `m_petugas` as a,`m_masjid` as b, `tr_pengeluaran` as c where a.`id_masjid`=b.`id_masjid` and a.`id_petugas`=c.`id_petugas` and c.`jenis_pengeluaran` = 'ZIS' and b.`id_masjid` = ".$_SESSION['id_masjid'];
    $hasil = mysqli_query($kdb, $sql) or die(mysqli_error());
    return $hasil;
}
...
function sql_penerimaan_ini_operasional()
{
    ...
    if($tgl_awal=="" AND $tgl_akhir=="") 
    {
        $sql = "SELECT SUM(nominal) as PenerimaanIni FROM `tr_infaq` WHERE tanggal BETWEEN '$tgl_awal' AND '$tgl_akhir' AND id_petugas = '".$_SESSION['id_petugas']."'";
    }
    else {
