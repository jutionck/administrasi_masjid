...
$sql_infaq = "SELECT a.*, b.nama_donatur FROM tr_sodaqoh a, m_donatur b WHERE a.id_petugas = '".$petugas."' AND b.id_donatur = a.id_donatur ORDER BY a.tanggal ASC";
...
// data pengeluaran
$sql_keluar = "SELECT * FROM tr_pengeluaran  WHERE id_petugas = '".$petugas."' AND jenis_pengeluaran = 'PEMBANGUNAN' ORDER BY tanggal ASC";
